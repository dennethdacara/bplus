...
@section('content')
	...
	<div class="container mtb">
  		<h2>View All Reservations <a href="{{ route('customerAddHomeServiceReservation') }}" class="btn btn-md btn-primary">Add New Home Service Reservation</a> <a href="{{ route('customerAddOnSpaReservation') }}" class="btn btn-md btn-primary">Add New On Spa Reservation</a></h2> 
